...
export function Favorites() {
  const [favorites, setFavorites] = useState<ActorDetailsType[]>([]);
            ...
            >
              ...
              <div className="p-4 pt-0">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-3 py-2 text-xs font-semibold text-red-600 bg-red-50 hover:bg-red-100 rounded-md transition"
                >
